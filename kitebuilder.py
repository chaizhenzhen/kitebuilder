...
def main():
    ...
    parse_parser.add_argument(
        ...
        metavar="FILE",
        type=str,
        help="File to output resulting schema to (default top_paths.json)",
        default="top_paths.json"
    )
    parse_parser.add_argument(
        "--output-file3",
        metavar="FILE",
        type=str,
        help="File to output resulting schema to (default top_paths_md5.json)",
        default="top_paths_md5.json"
    )
    parse_parser.add_argument(
        "--output-top",
        metavar="FILE",
        type=str,
        help="File to output resulting schema to (default top_1000.json)",
        default="top_1000.json"
    )
    ...
    if args.action == "parse":
        spec_count = parse_specs(args.scrape_dir, args.output_file, args.output_file2, args.output_file3,args.output_top,
                                 args.blacklist)
